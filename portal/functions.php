...
// firebase
wp_enqueue_script("firebaseAPP", QODE_ROOT."/js/app/firebase.js",array(),false,true);

// // firebase
// wp_enqueue_script("ionicBundle", QODE_ROOT."/js/app/lib/ionic-bundle.js",array(),false,true);

wp_enqueue_script("firebaseFuntions", QODE_ROOT."/js/firebase-funtions.js",array(),false,true);

// angular
wp_enqueue_script("angularMaster", QODE_ROOT."/js/app/lib/angular.min.js",array(),false,true);

// ================================= Scripts do APP ===============================================================

// // ng-cordova
// wp_enqueue_script("ngCordova", QODE_ROOT."/js/app/lib/ng-cordova.min.js",array(),false,true);

// ng-cordova
wp_enqueue_script("angularRouter", QODE_ROOT."/js/app/lib/angular-ui-router.min.js",array(),false,true);

// ng-storage
wp_enqueue_script("ngStorage", QODE_ROOT."/js/app/lib/ngStorage.min.js",array(),false,true);

// angular fire
wp_enqueue_script("angularfire", QODE_ROOT."/js/app/lib/angularfire.min.js",array(),false,true);

// angular message
wp_enqueue_script("angularMessages", QODE_ROOT."/js/app/lib/angular-messages.min.js",array(),false,true);

// angulas translate
wp_enqueue_script("angularTranslate", QODE_ROOT."/js/app/lib/angular-translate.min.js",array(),false,true);

// angular translate loader static files
wp_enqueue_script("angularLoaderStatic", QODE_ROOT."/js/app/lib/angular-translate-loader-static-files.min.js",array(),false,true);

// angular local storage
wp_enqueue_script("angularLocalStorage", QODE_ROOT."/js/app/lib/angular-local-storage.min.js",array(),false,true);


// app js
wp_enqueue_script("appJs", QODE_ROOT."/js/app/app.js",array(),false,true);

// app js
wp_enqueue_script("controllers", QODE_ROOT."/js/app/controllers/controllers.js",array(),false,true);

// home do app
wp_enqueue_script("homeController", QODE_ROOT."/js/app/controllers/home-controller.js",array(),false,true);

// histórico do app
wp_enqueue_script("historyController", QODE_ROOT."/js/app/controllers/history-controller.js",array(),false,true);

// lista do app
wp_enqueue_script("listController", QODE_ROOT."/js/app/controllers/list-controller.js",array(),false,true);

// tutoria do app 
wp_enqueue_script("listEditController", QODE_ROOT."/js/app/controllers/list-edit-mode-controller.js",array(),false,true);

// detalhe de produto do app
wp_enqueue_script("ProductDetailController", QODE_ROOT."/js/app/controllers/product-detail-controller.js",array(),false,true);

// busca do app
wp_enqueue_script("buscaAppController", QODE_ROOT."/js/app/controllers/search-controller.js",array(),false,true);

// pegada hídrica do app
wp_enqueue_script("consumoController", QODE_ROOT."/js/app/controllers/consumo-controller.js",array(),false,true);

// página inútil do app ahahha
wp_enqueue_script("consumoEditModeController", QODE_ROOT."/js/app/controllers/consumo-edit-mode-controller.js",array(),false,true);

// preferencias do app
wp_enqueue_script("preferencesController", QODE_ROOT."/js/app/controllers/preferences-controller.js",array(),false,true);

// serviços do do app
wp_enqueue_script("servicesController", QODE_ROOT."/js/app/services.js",array(),false,true);

// serviço auth do app
wp_enqueue_script("authApp", QODE_ROOT."/js/app/services/auth.js",array(),false,true);
...
add_action( 'your-custom-action', 'tv_bp_avatar_upload_form' );

// notificacao contador [notificacoes]
function add_notification_to_side() {
	
	//do not change if the user is not logged in
	
	$user_id = get_current_user_id();//logged in user's id
	
	$num = bp_notifications_get_unread_notification_count( $user_id );
	
	return $num;
	
	
}
add_shortcode( 'notificacoes', 'add_notification_to_side' );
